...
namespace WinGenerateCodeDB.Code
{
    ...
    {
        public static string CreateASPX(string name_space, string table_name, int action, List<SqlColumnInfo> colList)
        {
        ...
        private static string CreatePageHead(string name_space, string table_name)
        {
