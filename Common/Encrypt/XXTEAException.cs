...
namespace Common
{
    public class XXTEAException : Exception
    {
        public XXTEAException() { }
        public XXTEAException(string message) : base(message) { }
        public XXTEAException(string message, Exception inner) : base(message, inner) { }
    }

    public class XXTEA_Old
    {
        private XXTEA_Old()
        {
        }
